...
@Component({
  selector: 'app-list-to-approve',
  templateUrl: './list-to-approve.component.html',
  styleUrls: ['./list-to-approve.component.scss'],
  animations: [
...
export class ListToApproveComponent implements OnInit {
  ...
  constructor(private pentadbir: PentadbirService) {
    this.pentadbir.getAllActivePPL().subscribe((res) =>{
      this.rows = res;
    })
  }
