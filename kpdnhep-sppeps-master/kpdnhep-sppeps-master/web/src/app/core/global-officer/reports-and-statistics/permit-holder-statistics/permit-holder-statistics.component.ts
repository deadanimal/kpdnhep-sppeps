...
@Component({
  selector: 'app-permit-holder-statistics',
  templateUrl: './permit-holder-statistics.component.html',
  styleUrls: ['./permit-holder-statistics.component.scss']
})
export class PermitHolderStatisticsComponent implements OnInit {
