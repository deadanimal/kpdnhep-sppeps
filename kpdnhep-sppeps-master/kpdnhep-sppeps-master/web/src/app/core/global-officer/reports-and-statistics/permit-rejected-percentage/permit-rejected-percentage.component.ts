...
@Component({
  selector: 'app-permit-rejected-percentage',
  templateUrl: './permit-rejected-percentage.component.html',
  styleUrls: ['./permit-rejected-percentage.component.scss']
})
export class PermitRejectedPercentageComponent implements OnInit {
