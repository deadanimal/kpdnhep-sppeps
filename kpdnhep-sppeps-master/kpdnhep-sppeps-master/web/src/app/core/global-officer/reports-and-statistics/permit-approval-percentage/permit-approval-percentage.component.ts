...
@Component({
  selector: 'app-permit-approval-percentage',
  templateUrl: './permit-approval-percentage.component.html',
  styleUrls: ['./permit-approval-percentage.component.scss']
})
export class PermitApprovalPercentageComponent implements OnInit {
  ...
  updateFilter(event) {
    ...
    const temp = this.temp.filter(function (d) {
      return (
        ...
        // (d.approveDate.toLowerCase().indexOf(val) !== -1 || !val) ||
