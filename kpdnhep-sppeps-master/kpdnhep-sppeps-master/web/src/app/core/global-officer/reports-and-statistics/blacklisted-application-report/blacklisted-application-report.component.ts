...
@Component({
  selector: 'app-blacklisted-application-report',
  templateUrl: './blacklisted-application-report.component.html',
  styleUrls: ['./blacklisted-application-report.component.scss']
})
export class BlacklistedApplicationReportComponent implements OnInit {
  ...
  tableRows = [
    {
      permit: "11001",
      blacklistDate: new Date(2021, 0, 1),
    ...
    {
      permit: "11002",
      blacklistDate: new Date(2021, 0, 2),
    ...
    {
      permit: "11004",
      blacklistDate: new Date(2021, 0, 5),
    ...
    {
      permit: "11004",
      blacklistDate: new Date(2021, 0, 7),
  ...
  filterCharts() {
    ...
    const filteredTable = this.temp.filter(el => new Date(el.blacklistDate).getTime() >= startDate.getTime() && new Date(el.blacklistDate).getTime() <= endDate.getTime());
    // const temp = this.temp.filter(function (d) {
    //   return (
    //     (d.blacklistDate.indexOf(startDate) !== -1 || !startDate) 
    //   );
    // });
